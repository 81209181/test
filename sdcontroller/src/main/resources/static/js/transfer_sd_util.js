...
Transfer.prototype.apptObj = "";
Transfer.prototype.cancelObj = "";
Transfer.prototype.hiddenForm = "";
Transfer.prototype.make = function(obj, url) {
    var data = obj.data;
    var targetUrl = url + "/sd/JobTransferDisplayPublic.action";
    /*
     *
...
Transfer.prototype.cancel = function(obj) {
    // TODO : to implement the cancel function
};

Transfer.prototype.query = function(obj) {
    // TODO : to implement the query function
};


var TransferSDObj = new Transfer();