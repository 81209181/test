...
@Controller
@RequestMapping("/system/serviceTypeMapping")
public class ServiceTypeOfferMappingController {
    ...
    @GetMapping("/serviceTypeMappingList")
    ...
    @PostMapping("/updateServiceTypeMapping")
    ...
    @PostMapping("/deleteServiceTypeMapping")
