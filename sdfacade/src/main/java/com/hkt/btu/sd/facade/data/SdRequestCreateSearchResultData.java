...
public class SdRequestCreateSearchResultData implements DataInterface {
    ...
    public SdRequestCreateSearchResultData setBnCtrl(boolean bnCtrl) {
        this.bnCtrl = bnCtrl;
        return this;
    }
    ...
    public SdRequestCreateSearchResultData setVoIpCtrl(boolean voIpCtrl) {
    ...
    public SdRequestCreateSearchResultData setCloudCtrl(boolean cloudCtrl) {
