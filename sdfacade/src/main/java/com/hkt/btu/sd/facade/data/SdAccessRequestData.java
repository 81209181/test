...
public class SdAccessRequestData implements DataInterface {
    ...
    private List<SdAccessRequestVisitorData> visitorDataList;
    private Integer visitorCount;

    private List<SdAccessRequestEquipData> equipDataList;
    ...
    public List<SdAccessRequestVisitorData> getVisitorDataList() {
        return visitorDataList;
    }

    public void setVisitorDataList(List<SdAccessRequestVisitorData> visitorDataList) {
        this.visitorDataList = visitorDataList;
    }

    public List<SdAccessRequestEquipData> getEquipDataList() {
        return equipDataList;
    }

    public void setEquipDataList(List<SdAccessRequestEquipData> equipDataList) {
