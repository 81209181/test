...
public class SdAccessRequestDataPopulator extends AbstractDataPopulator<SdAccessRequestData> {
    ...
    public void populate(SdAccessRequestBean source, SdAccessRequestData target) {
    ...
    public void populateSensitiveData(SdAccessRequestBean source, SdAccessRequestData target) {
        // requester
        if(source.getRequester() != null){
