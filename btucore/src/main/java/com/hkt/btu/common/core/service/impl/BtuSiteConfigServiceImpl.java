...
public class BtuSiteConfigServiceImpl implements BtuSiteConfigService {
    ...
    private void reloadConfigFromDb(BtuSiteConfigBean siteConfigBean) {
        ...
        String sitHostname = MapUtils.getString(map, BtuConfigParamEntity.SITE.CONFIG_KEY_SIT_HOSTNAME);
        ...
        } else if ( StringUtils.equals(serverHostname, sitHostname) ){
            siteConfigBean.setServerType(BtuSiteConfigBean.SERVER_TYPE.SIT);
        } else {
