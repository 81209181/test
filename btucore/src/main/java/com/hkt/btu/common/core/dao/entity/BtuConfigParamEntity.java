...
public class BtuConfigParamEntity extends BaseEntity {
    ...
    public static class SITE{
        ...
        public static final String CONFIG_KEY_SIT_HOSTNAME = "sitHostname";
    ...
    public static class API {
        public static class CONFIG_KEY {
            ...
            public static final String PRINT_RESPONSE = "printResult";
        }

        public static class CONFIG_GROUP {
            public static final String API_ALFRESCO = "API_ALFRESCO";
        }
    }
