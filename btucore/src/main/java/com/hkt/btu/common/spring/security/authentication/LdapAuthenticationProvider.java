...
import com.hkt.btu.common.spring.security.core.userdetails.BtuLoginMethod;
    ...
    public Authentication authenticate(Authentication auth) throws AuthenticationException {
        ...
        try {
            ...
            userDetails = BtuUser.of(btuUserBean.getUserId(),
                    ...
                    btuUserBean);
            userDetails.setEncryptLdapPassword(sensitiveDataService.encryptFromStringSafe(loginPwd));
            ...
            userDetails.setLoginMethod(BtuLoginMethod.LDAP_LOGIN);
