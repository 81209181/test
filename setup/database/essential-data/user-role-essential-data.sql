...
values ('SYS_ADMIN', 'System Admin', 'BASIC', 'A', null, '81149189', '81149189', 'System Admin');
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, ABSTRACT, CREATEBY, MODIFYBY, REMARKS)
values ('TEAM_HEAD', 'Team Head', 'BASIC', 'A', 'Y', '81149189', '81149189', 'Team Head');
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, ABSTRACT, CREATEBY, MODIFYBY, REMARKS)
values ('OPT', 'Operator', 'BASIC', 'A', 'Y', '81149189', '81149189', 'Operator');
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, ABSTRACT, CREATEBY, MODIFYBY, REMARKS)
values ('ENG', 'Engineer', 'BASIC', 'A', 'Y', '81149189', '81149189', 'Engineer');
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, ABSTRACT, CREATEBY, MODIFYBY, REMARKS)
...
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, CREATEBY, MODIFYBY, REMARKS)
values ('O_NFM', 'NFM', 'OPT', 'A', '01634476', '01634476', null);
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, CREATEBY, MODIFYBY, REMARKS)
values ('TH__O_NFM', 'NFM Team Lead', 'TEAM_HEAD', 'A', '01634476', '01634476', null);

insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, CREATEBY, MODIFYBY, REMARKS)
values ('O_USC', 'USC', 'OPT', 'A', '01634476', '01634476', null);
insert into user_role (ROLE_ID, ROLE_DESC, PARENT_ROLE_ID, STATUS, CREATEBY, MODIFYBY, REMARKS)
values ('TH__O_USC', 'USC Team Lead', 'TEAM_HEAD', 'A', '01634476', '01634476', null);
