...
Insert into SD.USER_ROLE (ROLE_ID,ROLE_DESC,PARENT_ROLE_ID,STATUS,ABSTRACT,CREATEDATE,CREATEBY,MODIFYDATE,MODIFYBY,REMARKS) values ('TH__E_TEAM_GMB','GMB Team Head','TEAM_HEAD','A',null,sysdate,'00496877',sysdate,'00496877','GMB Team Head');
Insert into SD.USER_ROLE (ROLE_ID,ROLE_DESC,PARENT_ROLE_ID,STATUS,ABSTRACT,CREATEDATE,CREATEBY,MODIFYDATE,MODIFYBY,REMARKS) values ('E_TEAM_METER',  'Meter',        'ENG',      'A',null,sysdate,'00496877',sysdate,'00496877','GMB Team Engineer');
