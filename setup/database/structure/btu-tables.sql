...
CREATE INDEX IDX_USER_PROFILE_1 ON USER_PROFILE (EMAIL);
...
-- USER ROLE SERVICE TYPE MAPPING
CREATE TABLE USER_ROLE_SERVICE_TYPE
(
    ROLE_ID           VARCHAR2(20)         not null,
...
CREATE UNIQUE INDEX IDX_USER_ROLE_SERVICE_TYPE ON USER_ROLE_SERVICE_TYPE (ROLE_ID, SERVICE_TYPE_CODE);
