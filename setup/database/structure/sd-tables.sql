...
CREATE INDEX IDX_SYMPTOM_MAPPING_2 ON SYMPTOM_MAPPING (SYMPTOM_GROUP_CODE);
CREATE INDEX IDX_SYMPTOM_MAPPING_3 ON SYMPTOM_MAPPING (SYMPTOM_CODE);
CREATE UNIQUE INDEX IDX_SYMPTOM_MAPPING_4 ON SYMPTOM_MAPPING (SERVICE_TYPE_CODE, SYMPTOM_GROUP_CODE, SYMPTOM_CODE);
