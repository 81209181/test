...
public class SdAccessRequestBean extends BaseBean {
    private Integer accessRequestId;
    private Integer hashedRequestId;
    private String status;

    private SdUserBean requester;
    private SdCompanyBean requesterCompany;
    ...
    private List<SdAccessRequestVisitorBean> requestVisitorBeanList;
    private Integer visitorCount;

    private List<SdAccessRequestEquipBean> requestEquipBeanList;
    ...
    public SdUserBean getRequester() {
        return requester;
    }

    public void setRequester(SdUserBean requester) {
        this.requester = requester;
    }

    public SdCompanyBean getRequesterCompany() {
        return requesterCompany;
    }

    public void setRequesterCompany(SdCompanyBean requesterCompany) {
    ...
    public List<SdAccessRequestVisitorBean> getRequestVisitorBeanList() {
        return requestVisitorBeanList;
    }

    public void setRequestVisitorBeanList(List<SdAccessRequestVisitorBean> requestVisitorBeanList) {
    ...
    public List<SdAccessRequestEquipBean> getRequestEquipBeanList() {
        return requestEquipBeanList;
    }

    public void setRequestEquipBeanList(List<SdAccessRequestEquipBean> requestEquipBeanList) {
